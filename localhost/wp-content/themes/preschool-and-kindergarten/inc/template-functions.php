        ...
        <div class="mobile-menu">
            ...
            <ul class="contact-info">
                <?php
                    if($email_address){ ?>
                        <li>
                           <a href="<?php echo esc_url( 'mailto:' . sanitize_email( $email_address ) ); ?>"><span class="fa fa-envelope"></span>
                ...
                <?php
                    if($phone_number){ ?>
                        <li>
                            <a href="<?php echo esc_url( 'tel:' . preg_replace( '/[^\d+]/', '', $phone_number ) ); ?>">
...
add_action( 'preschool_and_kindergarten_header', 'preschool_and_kindergarten_mobile_navigation_header', 5 );
...
function preschool_and_kindergarten_footer_bottom(){
    ...
    <?php if( $copyright_text ){
            ...
            echo esc_html__( '&copy; Copyright ', 'preschool-and-kindergarten' ) . date_i18n( esc_html__( 'Y', 'preschool-and-kindergarten' ) ); ?>
