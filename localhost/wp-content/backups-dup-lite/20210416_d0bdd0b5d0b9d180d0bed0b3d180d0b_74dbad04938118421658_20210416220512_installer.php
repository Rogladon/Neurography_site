...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210416_d0bdd0b5d0b9d180d0bed0b3d180d0b_74dbad04938118421658_20210416220512_archive.zip';
	const ARCHIVE_SIZE		 = '41997638';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '74dbad0-16220512';
    const SECONDARY_PACKAGE_HASH = '7356b28-16220512';
	const VERSION			 = '1.4.0';
